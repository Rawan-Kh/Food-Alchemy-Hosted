...
interface FreeRecipeScrapingDialogProps {
  onRecipeScraped: (recipe: Omit<Recipe, 'id' | 'dateAdded'>) => void;
}

export const FreeRecipeScrapingDialog: React.FC<FreeRecipeScrapingDialogProps> = ({ onRecipeScraped }) => {
            ...
            <CardContent className="pt-6">
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  Enter any recipe website URL. This tool is completely free and works with most recipe websites.
                </p>
                <Button 
