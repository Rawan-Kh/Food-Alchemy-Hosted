...
export const MealPlanner: React.FC<MealPlannerProps> = ({
  ...
  return <div className="space-y-6">
      <Card>
        ...
        <CardContent>
          {!currentWeekPlan ? <div className="text-center py-8">
              ...
              <div className="flex justify-between items-center flex-wrap ">
                ...
                <div className="flex gap-2 flex-wrap mt-6  ">
                  <Button variant="outline" onClick={generateShoppingListForPlan} disabled={!!currentShoppingList}>
                    Generate Shopping List
                  </Button>
                  <Button variant="outline" onClick={cancelMealPlan} className="text-red-600 hover:text-red-700">
              ...
              <MealPlanGrid weekPlan={currentWeekPlan} recipes={recipes} onAssignRecipe={assignRecipeToMeal} onRemoveRecipe={removeRecipeFromMeal} getRecipeById={getRecipeById} />
            </div>}
        </CardContent>
      </Card>

      {currentShoppingList && <ShoppingListManager shoppingList={currentShoppingList} onToggleItem={toggleShoppingListItem} onAddToPantry={addShoppingItemToPantry} onCompleteShoppingList={completeShoppingList} />}

      <MealPlanHistoryDropdown history={mealPlanHistory} getRecipeById={getRecipeById} onDeleteHistory={deleteFromHistory} />
    </div>;
};